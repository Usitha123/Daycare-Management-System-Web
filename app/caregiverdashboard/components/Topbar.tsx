  ...
  return (
    <header className="h-16 bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between px-4 md:px-6 sticky top-0 z-30 transition-colors duration-200">
      ...
      <div className="flex items-center gap-3 md:gap-5">
        ...
        {/* Notification */}
        <button className="relative p-2 text-slate-600 dark:text-zinc-400 hover:bg-slate-100 dark:hover:bg-zinc-800 rounded-xl transition-colors">
          <Bell size={20} />
        ...
        <div className="flex items-center gap-3 cursor-pointer">
          <div className="w-9 h-9 md:w-10 md:h-10 rounded-xl bg-gradient-to-tr from-amber-500 to-orange-600 text-white flex items-center justify-center font-bold shadow-md">
            CG
          </div>
